      ...
      <Popover className="relative h-full">
        <div className="h-full flex items-center">
          ...
          >
            ...
            <span className="hidden md:inline text-xs tracking-widest uppercase">{dictionary?.nav?.cart ?? "SEPET"}</span>
        ...
        >
          ...
          >
            <div className="p-4 flex items-center justify-center">
              <h3 className="text-large-semi">{dictionary?.cart?.title ?? "Sepet"}</h3>
            </div>
