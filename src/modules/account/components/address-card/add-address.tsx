...
const AddAddress = ({
  ...
  return (
    <>
      ...
      >
        <span className="text-base-semi">{dictionary?.account?.new_address ?? "New address"}</span>
        <Plus />
      </button>

      <Modal isOpen={state} close={close} data-testid="add-address-modal">
        <Modal.Title>
          <Heading className="mb-2">{dictionary?.account?.add_address ?? "Add address"}</Heading>
        </Modal.Title>
